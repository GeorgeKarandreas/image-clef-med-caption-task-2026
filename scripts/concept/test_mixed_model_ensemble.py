"""Weighted soft-vote ensemble of concept task models on test images."""
...
IMG_DIR_PATH = PROJECT_ROOT / "data" / "test" / "images"
...
MODEL_PATHS = [
    MODELS_DIR / "convnext" / "20260505_001526_convnext_img224_seed66" /"model.pt",
    MODELS_DIR / "swinsmall" / "20260429_160625_swinsmall_img224_seed42" / "model.pt",
    MODELS_DIR / "convnext-tiny" / "20260429_205719_convnext-tiny_img320_seed42" / "model.pt",
    MODELS_DIR / "dinov2" / "20260429_123824_dinov2_img224_seed42" / "model.pt",
    MODELS_DIR / "efficientnetv2" / "20260429_145337_efficientnetv2_img320_seed42" / "model.pt",
]

MODEL_WEIGHTS = [0.5, 0.5, 0.1, 0.1, 0.1]
...
def main():
    ...
    csv_name = (
        f"mixed_model_vote_ensemble_test_submission_{datetime.now().strftime('%H%M%S')}.csv"
