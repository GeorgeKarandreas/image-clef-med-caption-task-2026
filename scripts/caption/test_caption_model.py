"""Generate a caption submission.csv for the test set."""
...
MODEL_DIR = PROJECT_ROOT / "models" / "caption"
RESULTS_DIR = PROJECT_ROOT / "results" / "caption"
OUTPUT_PATH = RESULTS_DIR / f"caption_submission_{datetime.now().strftime('%H%M%S')}.csv"
